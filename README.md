...
3. Crear una aplicación en Heroku para realizar el deploy de nuestro e-commerce. Nombrarla de la siguiente manera _username_-mp-commerce-php. Ejemplo:
...
5. Activar el deploy autómatico ante cualquier cambio en el branch "master". Reali∏zar un deploy manualmente, mediante la opción "Deploy branch" para comprobar que la app esté funcionando correctamente.
